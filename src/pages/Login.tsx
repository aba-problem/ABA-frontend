  ...
  return (
    <div className="min-h-screen bg-[#09090B] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-[400px]">
        ...
        {/* Card */}
        <div className="rounded-[16px] border border-[#2B2D31] bg-[#111217] p-8">
          <div className="text-center mb-8">
            <h1 className="text-[22px] font-semibold text-[#F5F5F5] mb-2">Welcome back</h1>
            <p className="text-[14px] text-[#71717A]">Sign in to access your databases</p>
          </div>
